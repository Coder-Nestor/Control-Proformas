    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <?php if ($isEdit && !empty($documentos)): ?>
                <label class="form-label small fw-semibold text-secondary mb-2">Documentos actuales en esta entrega:</label>
                    ...
                    <?php foreach ($documentos as $doc): ?>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center py-2 bg-white border rounded-3 mb-2 shadow-xs" id="doc-item-<?= $doc['id'] ?>">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                <a href="<?= base_url('uploads/entregas/' . e($doc['nombre_archivo'])) ?>" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill px-3">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Documentos que YA están guardados en esta entrega (cuentan para el límite de 2)
