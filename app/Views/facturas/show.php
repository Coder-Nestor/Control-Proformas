        ...
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <h4 class="mb-0 fw-bold text-primary">
                    ...
                    <span class="badge bg-light text-muted fw-normal align-middle" style="font-size: 0.6em;" ?></span>
                </h4>
                ...
                <?php if (!empty($f['n_proforma'])): ?>
                    <span class="badge bg-success-subtle text-success fw-normal px-3 py-2">
                        <i class="bi bi-file-earmark me-1"></i><?= e($f['n_proforma']) ?>
                    </span>
                <?php endif; ?>
            </div>
    ...
    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    ...
                                    <span class="fw-semibold"><?= e($f['n_oce_interna'] ?? '—') ?></span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small">N° Factura</span>
                                    <span class="fw-semibold"><?= e($f['n_factura'] ?? '—') ?></span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small">Fecha de envío de OCE</span>
                                    <span class="fw-semibold"><?= fmt_date($f['fecha_envio_oce']) ?></span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small">Proforma</span>
                                    <span class="fw-semibold"><?= e($f['n_proforma'] ?? '—') ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    ...
                                    <span class="badge text-bg-<?= $badgeClass[$f['estado']] ?? 'secondary' ?>"><?= e($estados[$f['estado']]) ?></span>
                                </div>
                                <div class="d-flex justify-content-between border-bottom pb-1">
                                    <span class="text-muted small">Fecha de entrega de factura</span>
                                    <span class="fw-semibold"><?= fmt_date($f['fecha_entrega_factura']) ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="bg-light rounded-3 p-3 mt-1">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-muted small">Tiempo entre envío OC y entrega factura:</span>
                                        <?php if ($dias !== null): ?>
                                        ...
                                        <?php elseif ($diasEnCurso !== null): ?>
                                            <span class="badge <?= $diasEnCurso > 8 ? 'bg-warning text-dark' : 'bg-warning text-dark' ?> fw-normal px-3 py-2">
                                                <i class="bi bi-hourglass-split me-1"></i><?= $diasEnCurso ?> días sin entregar
                                            </span>
                                        <?php else: ?>
                                            <span class="badge bg-secondary fw-normal px-3 py-2">Sin fecha de envío</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0"><?= nl2br(e($f['comentario'])) ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="text-center py-4">
                            ...
                            <a href="<?= base_url('/facturas/' . $f['id'] . '/editar') ?>" class="btn btn-outline-primary btn-sm rounded-pill">
        ...
        <div class="col-lg-5">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-bottom-0 pt-3 pb-0">
                    <h6 class="fw-bold text-secondary mb-0">
                        <i class="bi bi-cart-check me-2 text-primary"></i>Orden de compra relacionada
                    </h6>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3">
                        <div>
                            <div class="fw-semibold">OCE <?= e($f['n_oce_interna'] ?? '#' . $f['orden_compra_id']) ?></div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-bottom-0 pt-3 pb-0">
                    <h6 class="fw-bold text-secondary mb-0">
                        <i class="bi bi-truck me-2 text-primary"></i>Entrega
                    </h6>
                </div>
                <div class="card-body">
                    <?php if ($entrega): ?>
                        <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3">
                            <div>
                                <div class="text-muted small">
                                    <i class="bi bi-calendar3 me-1"></i>Entregada al dueño: <span class="fw-semibold text-dark"><?= fmt_date($entrega['fecha_entrega_dueno']) ?></span>
                                </div>
                                <div class="text-muted small mt-1">
                                    <i class="bi bi-send me-1"></i>Solicitud de pago: <span class="fw-semibold text-dark"><?= fmt_date($entrega['fecha_solicitud_revision_pago']) ?></span>
                                </div>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mb-2">Esta factura todavía no tiene registro de entrega.</p>
