        ...
        <div class="col-lg-7">
            ...
            <div class="card detail-card mb-4">
                ...
                <div class="card-body">
                            ...
                            <?php foreach ($documentos as $doc): ?>
                                ...
                                <div class="doc-preview-box">
                                    ...
                                    <div class="flex-shrink-0 d-flex gap-2">
                                        <a href="<?= base_url('uploads/proformas/' . e($doc['nombre_archivo'])) ?>" 
                                           target="_blank" 
                    ...
                    <?php elseif (!empty($p['documento_pdf'])): ?>
                        <div class="doc-preview-box">
                    ...
                    <?php else: ?>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted mb-2 small mt-2">No hay documentos adjuntos para esta proforma.</p>
                            <?php if (Auth::can('proformas.editar')): ?>
